 ...
 *
 */
public interface ISortableList<E extends Comparable<E>> extends Iterable<E>, IBag<E> {
    ...
    /**
     * Add the element to the list with some additional information.
     *
     * int can be changed to T to accept any type as parameter.
     *
     * @param element item to be added
     * @param pos additional information linked with the element
     */
